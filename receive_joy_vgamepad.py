...
class VirtualControllerMapper:
    ...
    def __init__(self, quiet=False):
        ...
        self.axis_values = {
            ...
            2: 0,  # Right stick X
            3: 0,  # Right stick Y
            4: -32767,  # Left trigger (starts at minimum)
            5: -32767,  # Right trigger (starts at minimum)
        }
